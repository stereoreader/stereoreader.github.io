import{E as e,F as t,P as n,Q as r,et as i,ft as a,k as o,ot as s,pt as c,wt as l,yt as u}from"./B498Pdn7.js";import{v as d}from"./DoqKqwoz.js";import{t as f}from"./BNSBsTEL.js";import{t as p}from"./C7NiIm7g.js";import{t as m}from"./BDNMzG2s.js";import{t as h}from"./DMhMhGEV.js";import{t as g}from"./Cd2yUGS2.js";import{t as _}from"./DJERm4gu.js";var v=`Modern JavaScript applications often process large amounts of data before anything is rendered: filtering, mapping, grouping, sorting, formatting, diffing, normalizing API responses, preparing view models, and running framework-level update logic. In small isolated cases the difference between two implementations may look irrelevant, but in real applications these operations are usually repeated many times. Small overheads accumulate, especially on low-end devices, older hardware, and mobile browsers.
...
<script src="https://cdn.jsdelivr.net/gh/silentmantra/benchmark/loader.js"><\/script>
<!-- <script type="module" src="http://localhost:8001/benchmark.js"><\/script> -->`,y={class:`wrapper`,"show-benchmark-code":``},b={src:h,class:`cover`},x={class:`subtitle subtitle-2`},S={class:`subtitle subtitle-2`},C=[`innerHTML`],w=`const arr = Array.from({length: 100}, () => ({num: Math.random()}));

// @benchmark filter + map
arr.filter(n => n.num > .5).map(n => n.num * 2);

// @benchmark reduce
arr.reduce((r, n) => (n.num > .5 && r.push(n.num * 2), r), []);`,T=m({__name:`index`,setup(m){f({title:`JS benchmark`,link:[{rel:`icon`,type:`image/svg+xml`,href:g}]}),f({script:[{src:`https://cdn.jsdelivr.net/gh/silentmantra/benchmark/loader.js`}]});let h=new _({html:!0}).render(v),T=u();return r(()=>{let e=!1,t=()=>{e||!T.value||!window.SilentMantraBenchmark||(e=!0,window.SilentMantraBenchmark.set(T.value,w))};window.SilentMantraBenchmark?t():window.addEventListener(`silentmantra/benchmark:loaded`,t,{once:!0})}),(r,u)=>{let f=p,m=s(`transition-target`);return c((i(),o(`div`,y,[u[3]||=e(`h1`,null,[e(`img`,{src:`data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20width='32'%20height='32'%20id='gauge'%3e%3cg%20color='%23000'%20transform='translate(0%20-1020.362)'%3e%3cpath%20style='isolation:auto;mix-blend-mode:normal'%20fill='none'%20stroke='%23f05542'%20stroke-dashoffset='1.1'%20stroke-linejoin='round'%20stroke-width='4'%20d='M3.876%201043.362a14%2014%200%200%201%200-14%2014%2014%200%200%201%2012.124-7'%20overflow='visible'%3e%3c/path%3e%3ccircle%20cx='16'%20cy='1036.362'%20r='10'%20fill='%23f05542'%20overflow='visible'%20style='isolation:auto;mix-blend-mode:normal'%3e%3c/circle%3e%3cpath%20style='isolation:auto;mix-blend-mode:normal'%20fill='%232b4255'%20d='M26%201036.362a10%2010%200%200%201-7.412%209.66%2010%2010%200%200%201-11.248-4.66l8.66-5z'%20overflow='visible'%3e%3c/path%3e%3cpath%20style='isolation:auto;mix-blend-mode:normal'%20fill='%2325b39e'%20d='M16%201026.362a10%2010%200%200%201%209.46%206.758%2010%2010%200%200%201-3.326%2011.14L16%201036.362Z'%20overflow='visible'%3e%3c/path%3e%3cpath%20style='isolation:auto;mix-blend-mode:normal'%20fill='%23f8b84e'%20d='M16%201026.362a10%2010%200%200%201%209.66%207.412l-9.66%202.588Z'%20overflow='visible'%3e%3c/path%3e%3cpath%20style='isolation:auto;mix-blend-mode:normal'%20fill='none'%20stroke='%232b4255'%20stroke-dashoffset='1.1'%20stroke-linejoin='round'%20stroke-width='4'%20d='M24.547%201047.45a14%2014%200%200%201-11.263%202.646%2014%2014%200%200%201-9.408-6.734'%20overflow='visible'%3e%3c/path%3e%3cpath%20style='isolation:auto;mix-blend-mode:normal'%20fill='none'%20stroke='%23f8b84e'%20stroke-dashoffset='1.1'%20stroke-linejoin='round'%20stroke-width='4'%20d='M16%201022.362a14%2014%200%200%201%2013.523%2010.377'%20overflow='visible'%3e%3c/path%3e%3cpath%20style='isolation:auto;mix-blend-mode:normal'%20fill='none'%20stroke='%2325b39e'%20stroke-dashoffset='1.1'%20stroke-linejoin='round'%20stroke-width='4'%20d='M29.523%201032.739a14%2014%200%200%201-5.015%2014.741'%20overflow='visible'%3e%3c/path%3e%3c/g%3e%3c/svg%3e`}),n(` AlekLabs JS benchmark`)],-1),u[4]||=e(`div`,{class:`subtitle`},`A benchmark to write in pure JS and host anywhere`,-1),c(e(`img`,b,null,512),[[m,[(r._.provides[d]||r.$route).fullPath,`cover`]]]),e(`div`,x,[t(f,{to:`/js-benchmark/playground`},{default:a(()=>[...u[0]||=[n(`Open playground`,-1)]]),_:1}),u[1]||=e(`a`,{href:`https://stackoverflow.com/search?tab=newest&q=user%3a14098260%20benchmark&searchOn=3`,target:`_blank`},`My Stack Overflow answers with benchmarks`,-1)]),u[5]||=e(`h2`,{class:`benchmark-title`},`Try it`,-1),e(`div`,{ref_key:`$benchmark`,ref:T,class:`benchmark`},null,512),e(`div`,S,[t(f,{to:`/js-benchmark/playground#H4sIAAAAAAAACm3PQQrCMBQE0KsMWUiiIVbBTUXRA3gC6yK20Rab3%2FKbClJ6dylZqOBumMVjZhB5UziRiryhLsAyY4cjs32ZGzdeDrWjeyhTrJJk1JAKuz3kQL1PcbKhNGypaLxUo1LbjDJaLnG4OspLb%2FmBW1UHx1jA2zYjy2xiI2lyyFDvsYfZKONt%2B13Osf7nsSv63EUpZilZg%2BKsj4fZDGzavivlx9NgpXG%2BqK3QIlShnn5HBc%2FuZ6sY35i0sGoZAQAA`},{default:a(()=>[...u[2]||=[n(` Edit in playground`,-1)]]),_:1})]),e(`div`,{class:`content jsbench-content`,innerHTML:l(h)},null,8,C)])),[[m,[(r._.provides[d]||r.$route).fullPath,`article`]]])}}},[[`__scopeId`,`data-v-dc9313b2`]]);export{T as default};