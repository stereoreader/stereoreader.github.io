import{_ as t,f as a}from"./B61zhcUH.js";import{j as s}from"./BClBoi9A.js";import{M as r}from"./Do4ktST4.js";import{u as o}from"./DXARLB3D.js";import{a as i,g as c,i as l,d as h,N as u,z as m}from"./D2RfPzNg.js";const d=`Modern JavaScript applications often process large amounts of data before anything is rendered: filtering, mapping, grouping, sorting, formatting, diffing, normalizing API responses, preparing view models, and running framework-level update logic. In small isolated cases the difference between two implementations may look irrelevant, but in real applications these operations are usually repeated many times. Small overheads accumulate, especially on low-end devices, older hardware, and mobile browsers.
...
<script src="https://cdn.jsdelivr.net/gh/silentmantra/benchmark/loader.js"><\/script>
<!-- <script type="module" src="http://localhost:8001/benchmark.js"><\/script> -->`,p={class:"wrapper","show-benchmark-code":""},f=["innerHTML"],b={__name:"index",setup(g){o({title:"JS benchmark",link:[{rel:"icon",type:"image/svg+xml",href:a}]});const e=new r({html:!0}).render(d);return(k,n)=>(m(),c("div",p,[n[0]||(n[0]=l('<h1 data-v-a16a37e4><img src="'+t+'" data-v-a16a37e4> Alek JS benchmark</h1><div class="subtitle" data-v-a16a37e4>A benchmark to write in pure JS and host anywhere</div><img src="'+s+'" class="cover" data-v-a16a37e4><div class="subtitle subtitle-2" data-v-a16a37e4><a href="/js-benchmark/playground" data-v-a16a37e4>Open playground</a><a href="/js-benchmark/playground#H4sIAAAAAAAACm3PQQrCMBQE0KsMWUiiIVbBTUXRA3gC6yK20Rab3%2FKbClJ6dylZqOBumMVjZhB5UziRiryhLsAyY4cjs32ZGzdeDrWjeyhTrJJk1JAKuz3kQL1PcbKhNGypaLxUo1LbjDJaLnG4OspLb%2FmBW1UHx1jA2zYjy2xiI2lyyFDvsYfZKONt%2B13Osf7nsSv63EUpZilZg%2BKsj4fZDGzavivlx9NgpXG%2BqK3QIlShnn5HBc%2FuZ6sY35i0sGoZAQAA" data-v-a16a37e4>Try in playground: reduce vs filter + map</a><a href="https://stackoverflow.com/search?tab=newest&amp;q=user%3a14098260%20benchmark&amp;searchOn=3" target="_blank" data-v-a16a37e4>My Stack Overflow answers with benchmarks</a></div>',4)),h("div",{class:"content jsbench-content",innerHTML:u(e)},null,8,f)]))}},j=i(b,[["__scopeId","data-v-a16a37e4"]]);export{j as default};
