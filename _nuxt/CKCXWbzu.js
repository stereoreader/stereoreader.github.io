import{_ as l}from"./S4zgJLpz.js";import{g as u,d as e,k as t,a4 as h,P as m,l as r,a3 as i,R as p,M as d,C as f}from"./Cw2TUMUH.js";import{_ as b,f as g}from"./K6nwlLGE.js";import{j as k}from"./P4vKhAIa.js";import{M as y}from"./Do4ktST4.js";import{u as w}from"./P3iQF8nq.js";import{_ as x}from"./DlAUqK2U.js";const v=`Modern JavaScript applications often process large amounts of data before anything is rendered: filtering, mapping, grouping, sorting, formatting, diffing, normalizing API responses, preparing view models, and running framework-level update logic. In small isolated cases the difference between two implementations may look irrelevant, but in real applications these operations are usually repeated many times. Small overheads accumulate, especially on low-end devices, older hardware, and mobile browsers.
...
<script src="https://cdn.jsdelivr.net/gh/silentmantra/benchmark/loader.js"><\/script>
<!-- <script type="module" src="http://localhost:8001/benchmark.js"><\/script> -->`,A={class:"wrapper","show-benchmark-code":""},j={src:k,class:"cover"},_={class:"subtitle subtitle-2"},$=["innerHTML"],S={__name:"index",setup(T){w({title:"JS benchmark",link:[{rel:"icon",type:"image/svg+xml",href:g}]});const a=new y({html:!0}).render(v);return(s,n)=>{const o=l,c=d("transition-name");return f(),u("div",A,[n[3]||(n[3]=e("h1",null,[e("img",{src:b}),t(" AlekLabs JS benchmark")],-1)),n[4]||(n[4]=e("div",{class:"subtitle"},"A benchmark to write in pure JS and host anywhere",-1)),h(e("img",j,null,512),[[c,[(s._.provides[m]||s.$route).fullPath,"cover"]]]),e("div",_,[r(o,{to:"/js-benchmark/playground"},{default:i(()=>[...n[0]||(n[0]=[t("Open playground",-1)])]),_:1}),r(o,{to:"/js-benchmark/playground#H4sIAAAAAAAACm3PQQrCMBQE0KsMWUiiIVbBTUXRA3gC6yK20Rab3%2FKbClJ6dylZqOBumMVjZhB5UziRiryhLsAyY4cjs32ZGzdeDrWjeyhTrJJk1JAKuz3kQL1PcbKhNGypaLxUo1LbjDJaLnG4OspLb%2FmBW1UHx1jA2zYjy2xiI2lyyFDvsYfZKONt%2B13Osf7nsSv63EUpZilZg%2BKsj4fZDGzavivlx9NgpXG%2BqK3QIlShnn5HBc%2FuZ6sY35i0sGoZAQAA"},{default:i(()=>[...n[1]||(n[1]=[t("Try in playground: reduce vs filter + map",-1)])]),_:1}),n[2]||(n[2]=e("a",{href:"https://stackoverflow.com/search?tab=newest&q=user%3a14098260%20benchmark&searchOn=3",target:"_blank"},"My Stack Overflow answers with benchmarks",-1))]),e("div",{class:"content jsbench-content",innerHTML:p(a)},null,8,$)])}}},J=x(S,[["__scopeId","data-v-303ab1ec"]]);export{J as default};
