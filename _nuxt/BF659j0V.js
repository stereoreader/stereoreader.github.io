...
\r
Proceed carefully, avoid pain, respect recovery time, and treat this as serious physical training for the visual system rather than a quick medical cure.`,Fe=""+new URL("feature-read.IQWy9uUa.webp",import.meta.url).href,Le=""+new URL("feature-relax.D_xk9eHV.webp",import.meta.url).href,Ce=""+new URL("feature-train.COKS5ViJ.webp",import.meta.url).href,qe={class:"feature"},He=["src"],Ve=["innerHTML"],Ue=P({__name:"feature",props:{src:{},imageUrl:{}},setup(s){return(p,w)=>(E(),R("div",qe,[S("img",{src:s.imageUrl},null,8,He),S("span",{innerHTML:("parseMarkdown"in p?p.parseMarkdown:y(N))(s.src)},null,8,Ve)]))}}),B=J(Ue,[["__scopeId","data-v-0bdc777f"]]),$e={class:"lang-switch"},ze={key:0,href:"/stereo-reader/ru"},Ye={key:1,href:"/stereo-reader"},Ge={class:"cover"},Je=["innerHTML"],Ne={class:"features"},Qe={class:"story"},Ke=P({__name:"[...slug]",setup(s){const p=Object.assign({"./content/app.md":ge,"./content/bates.md":fe,"./content/feature1.md":pe,"./content/feature2.md":ye,"./content/feature3.md":be,"./content/goals.md":ve,"./content/join.md":we,"./content/lang/ru/app.md":_e,"./content/lang/ru/bates.md":xe,"./content/lang/ru/feature1.md":ke,"./content/lang/ru/feature2.md":Te,"./content/lang/ru/feature3.md":Ie,"./content/lang/ru/goals.md":De,"./content/lang/ru/join.md":Ae,"./content/lang/ru/results.md":Se,"./content/lang/ru/story.md":Re,"./content/lang/ru/title.md":Ee,"./content/lang/ru/warning.md":Me,"./content/results.md":je,"./content/story.md":Oe,"./content/title.md":Be,"./content/warning.md":Pe});let l=X().params.slug?.[0]||"en";if(l.length!==2)throw Z({statusCode:404,statusMessage:"Page not found"});ne({htmlAttrs:{lang:l}});function f(...i){const e={},r=Object.keys(p);for(const n of i){const a=r.find(o=>o.includes(l==="en"?`content/${n}.md`:`content/lang/${l}/${n}.md`));if(!a)throw new Error("Cant find page "+n);e[n]=p[a]}return e}const t=f("title","feature1","feature2","feature3","story","results","warning","app","goals","bates","join");return l==="en"?U({ogTitle:"Sharper Vision with Stereo Reader by Alek Labs",ogDescription:"Train or relax your eyes with Stereo Reader while reading books and documents in stereo or mono mode. Supports text, PDF, EPUB, FB2, images, stereo pairs, voice commands, mouse control, and timers.",ogImage:new URL("./assets/logo.jpg",import.meta.url).pathname}):U({ogTitle:"Исправляйте близорукость с помощью Стерео Чтения",ogDescription:"Тренируйте или расслабляйте глаза со Стерео Чтение, читая книги и документы в стерео- или моно-режиме. Поддерживает текст, PDF, EPUB, FB2, изображения, стереопары, голосовые команды, мышь и таймеры.",ogImage:new URL("./assets/logo.jpg",import.meta.url).pathname}),(i,e)=>{const r=W,n=ue;return E(),R(ee,null,[S("div",$e,[y(l)==="en"?(E(),R("a",ze,"Русский")):(E(),R("a",Ye,"English"))]),S("div",Ge,[k(r,{"image-src":y(te)},null,8,["image-src"]),S("div",{class:"text",innerHTML:("parseMarkdown"in i?i.parseMarkdown:y(N))(y(t).title)},null,8,Je)]),S("div",Ne,[k(B,{"image-url":y(Fe),src:y(t).feature1},null,8,["image-url","src"]),k(B,{"image-url":y(Le),src:y(t).feature2},null,8,["image-url","src"]),k(B,{"image-url":y(Ce),src:y(t).feature3},null,8,["image-url","src"])]),S("div",Qe,[k(n,{class:"chapter",src:y(t).story},null,8,["src"]),k(n,{class:"chapter",src:y(t).results},null,8,["src"]),k(n,{class:"chapter",src:y(t).app},null,8,["src"]),k(n,{class:"chapter",src:y(t).goals},null,8,["src"]),k(n,{class:"chapter",src:y(t).bates},null,8,["src"]),k(n,{class:"chapter",src:y(t).warning},null,8,["src"]),k(n,{class:"chapter",src:y(t).join},null,8,["src"])])],64)}}}),rt=J(Ke,[["__scopeId","data-v-5e0310bd"]]);export{rt as default};
