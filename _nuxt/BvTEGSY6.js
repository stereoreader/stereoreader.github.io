import"./DtOrA4js.js";import{p}from"./Cy0Em4ir.js";import{Y as m}from"./CFT98tUN.js";const h=""+new URL("cover.gIW4jzB_.webp",import.meta.url).href,g=""+new URL("cover.CCsFhWvG.webp",import.meta.url).href,f=""+new URL("cover.BoE8QZYc.webp",import.meta.url).href,y=`---\r
...
\r
Years later, I encountered the same general problem in BOOST at Luqon, but the requirements were different.\r
\r
...
\r
The third case comes from my personal project, Stereo Reader.\r
\r
...
`,s=Object.assign({"../content/experience/boost/cover.png":h,"../content/experience/hotels/cover.png":g,"../content/experience/scrolling/cover.png":f}),w=Object.assign({"../content/experience/boost/index.md":y,"../content/experience/hotels/index.md":b,"../content/experience/scrolling/index.md":v}),I=Object.entries(w).map(([n,t])=>{const l=t.replace(/^\uFEFF/u,"").replace(/\r\n?/g,`
`),r=/^---\n([\s\S]*?)\n---(?:\n|$)([\s\S]*)$/u.exec(l);if(!(typeof r?.[1]=="string"&&typeof r?.[2]=="string"))throw new Error("No meta for"+n);const e=p(r[1]);e.data=r[2],e.title=d(t),e.date=new Date(e.date),e.readOn??=[];const c=Object.keys(s).find(a=>a.includes(n.replace("index.md","")))??"",o=s[c];if(!o)throw new Error("No cover image for "+e.title);return e.coverUrl=o,e;function d(a){const u=m(a);for(const i of u)if(i.type==="heading"&&i.depth===1)return i.text.trim();return null}}).sort((n,t)=>n.order===void 0?t.order===void 0?0:1:t.order===void 0?-1:n.order-t.order);export{I as a};
