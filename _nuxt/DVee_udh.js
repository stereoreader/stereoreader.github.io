...
\r
[Open Stereo Reader and try it](/stereo-reader/app#try)`,pe=`## Why the Bates Method Was Not Enough\r
\r
...
\r
People who want to study the Bates method can still do so. It may have therapeutic value for some users. But in my opinion, its limitations should be recognized: relaxation alone is often not enough. In more difficult cases, real training may be required.`,me=`## Read your favorite books\r
\r
You can read text, PDF, EPUB, FB2 files in stereo or mono mode`,he=`## Relax your eyes\r
\r
...
[Abrir Stereo Reader y probarlo](/stereo-reader/app#try)
...
[Abrir la aplicación](/stereo-reader/app/)
...
[Ouvrir Stereo Reader et l’essayer](/stereo-reader/app#try)
...
[Открыть приложение](/stereo-reader/app/)`,Qt=`## Отказ от медицинских заявлений и меры безопасности
...
\r
[Open application](/stereo-reader/app/)`,cn=`## Disclaimer and Safety Precautions\r
\r
