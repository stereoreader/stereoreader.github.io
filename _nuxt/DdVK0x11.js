import"./DPNvknN0.js";import{p as h}from"./Cy0Em4ir.js";import{Y as m}from"./CFT98tUN.js";const u=""+new URL("cover.CbGmTKpN.webp",import.meta.url).href,b=""+new URL("cover.D7EDmnD9.webp",import.meta.url).href,y=""+new URL("cover.DrB9i5VT.webp",import.meta.url).href,f=`---\r
date: 2026-07-06\r
...
`,o=Object.assign({"../content/articles/hard-objects/cover.png":u,"../content/articles/mobile-web/cover.webp":b,"../content/articles/ui-layer/cover.webp":y}),w=Object.assign({"../content/articles/hard-objects/index.md":f,"../content/articles/mobile-web/index.md":g,"../content/articles/ui-layer/index.md":v}),k=Object.entries(w).map(([n,r])=>{const l=r.replace(/^\uFEFF/u,"").replace(/\r\n?/g,`
`),t=/^---\n([\s\S]*?)\n---(?:\n|$)([\s\S]*)$/u.exec(l);if(!(typeof t?.[1]=="string"&&typeof t?.[2]=="string"))throw new Error("No meta for"+n);const e=h(t[1]);e.data=t[2],e.title=d(r),e.date=new Date(e.date),e.readOn??=[];const c=Object.keys(o).find(a=>a.includes(n.replace("index.md","")))??"",i=o[c];if(!i)throw new Error("No cover image for "+e.title);return e.coverUrl=i,e;function d(a){const p=m(a);for(const s of p)if(s.type==="heading"&&s.depth===1)return s.text.trim();return null}}).sort((n,r)=>n.order===void 0?r.order===void 0?0:1:r.order===void 0?-1:n.order-r.order);export{k as a};
