import{_ as t,f as s}from"./BQ8X17go.js";import{j as a}from"./lEjscSmA.js";import{M as r}from"./Do4ktST4.js";import{u as o}from"./Bc_3EEiX.js";import{a as i,g as c,i as l,d as h,M as u,z as m}from"./KooKLqzj.js";const d=`Modern JavaScript applications often process large amounts of data before anything is rendered: filtering, mapping, grouping, sorting, formatting, diffing, normalizing API responses, preparing view models, and running framework-level update logic. In small isolated cases the difference between two implementations may look irrelevant, but in real applications these operations are usually repeated many times. Small overheads accumulate, especially on low-end devices, older hardware, and mobile browsers.
...
<script src="https://cdn.jsdelivr.net/gh/silentmantra/benchmark/loader.js"><\/script>
<!-- <script type="module" src="http://localhost:8001/benchmark.js"><\/script> -->`,p={class:"wrapper","show-benchmark-code":""},b=["innerHTML"],f={__name:"index",setup(g){o({title:"JS benchmark",link:[{rel:"icon",type:"image/svg+xml",href:s}]});const e=new r({html:!0}).render(d);return(k,n)=>(m(),c("div",p,[n[0]||(n[0]=l('<h1 data-v-cd502b4c><img src="'+t+'" data-v-cd502b4c> Alek JS benchmark</h1><div class="subtitle" data-v-cd502b4c>A benchmark to write in pure JS and host anywhere</div><img src="'+a+'" class="cover" data-v-cd502b4c><div class="subtitle subtitle-2" data-v-cd502b4c><a href="/js-benchmark/playground" data-v-cd502b4c>Open playground</a><a href="/js-benchmark/playground#H4sIAAAAAAAACm3PQQrCMBQE0KsMWUiiIVbBTUXRA3gC6yK20Rab3%2FKbClJ6dylZqOBumMVjZhB5UziRiryhLsAyY4cjs32ZGzdeDrWjeyhTrJJk1JAKuz3kQL1PcbKhNGypaLxUo1LbjDJaLnG4OspLb%2FmBW1UHx1jA2zYjy2xiI2lyyFDvsYfZKONt%2B13Osf7nsSv63EUpZilZg%2BKsj4fZDGzavivlx9NgpXG%2BqK3QIlShnn5HBc%2FuZ6sY35i0sGoZAQAA" data-v-cd502b4c>Try in playground: reduce vs filter + map</a><a href="https://stackoverflow.com/search?tab=newest&amp;q=user%3a14098260%20benchmark&amp;searchOn=3" target="_blank" data-v-cd502b4c>My Stack Overflow answers with benchmarks</a></div>',4)),h("div",{class:"content jsbench-content",innerHTML:u(e)},null,8,b)]))}},j=i(f,[["__scopeId","data-v-cd502b4c"]]);export{j as default};
