import"./Ru0MDjZU.js";import{p as u}from"./Cy0Em4ir.js";import{Y as m}from"./CFT98tUN.js";const h=""+new URL("cover.qYX_eQYy.webp",import.meta.url).href,g=""+new URL("cover.B_Dao0Q8.webp",import.meta.url).href,f=`---\r
...
`,s=Object.assign({"../content/experience/boost/cover.png":h,"../content/experience/hotels/cover.png":g}),v=Object.assign({"../content/experience/boost/index.md":f,"../content/experience/hotels/index.md":y}),T=Object.entries(v).map(([a,o])=>{const l=o.replace(/^\uFEFF/u,"").replace(/\r\n?/g,`
`),n=/^---\n([\s\S]*?)\n---(?:\n|$)([\s\S]*)$/u.exec(l);if(!(typeof n?.[1]=="string"&&typeof n?.[2]=="string"))throw new Error("No meta for"+a);const e=u(n[1]);e.data=n[2],e.title=d(o),e.date=new Date(e.date),e.readOn??=[];const c=Object.keys(s).find(t=>t.includes(a.replace("index.md","")))??"",i=s[c];if(!i)throw new Error("No cover image for "+e.title);return e.coverUrl=i,e;function d(t){const p=m(t);for(const r of p)if(r.type==="heading"&&r.depth===1)return r.text.trim();return null}});export{T as a};
