import{f as _,F as d,a as S,b as R,_ as B}from"./CGV1PplT.js";import{_ as F}from"./DcjAv_PT.js";import{f as j}from"./Yr2O_p7n.js";import{s as M}from"./Dsabq41V.js";import{l as u,x as E,w as z,z as p,g,k as a,M as n,d as r,a as y,W as m,F as q,j as h}from"./qtUZHJ6l.js";import{a as P}from"./Cqf9cLLU.js";import"./Do4ktST4.js";const A={class:"cover"},V=u({__name:"cover",setup(f){let o;return E(async()=>{const e=document.querySelector(".logo");o=M(()=>{if(!(Math.random()<.05)){t();return}const c=i(0,3),v=i(1,2),b=i(.8,2.5),w=i(-40,40),s=i(.2,.5),x=i(-8*s,8*s),I=i(1-.1*s,1+.1*s),k=i(.75,1);e.style.filter=[`blur(${c.toFixed(2)}px)`,`brightness(${v.toFixed(2)})`,`contrast(${b.toFixed(2)})`,`hue-rotate(${w.toFixed(2)}deg)`].join(" "),e.style.transform=[`translateX(${x.toFixed(2)}px)`,`scaleY(${I.toFixed(3)})`].join(" "),e.style.opacity=k.toFixed(2);const T=i(40,180);setTimeout(t,T)},120);function t(){e.style.filter="",e.style.transform="",e.style.opacity=""}function i(l,c){return Math.random()*(c-l)+l}}),z(()=>{clearInterval(o)}),(e,t)=>{const i=F;return p(),g("div",A,[a(i,{"image-src":n(j)},null,8,["image-src"]),t[0]||(t[0]=r("div",{class:"text"},[r("h1",null,"STEREO READER"),r("div",{class:"promo"}," Train or relax your eyes while reading your favorite books")],-1))])}}}),H=y(V,[["__scopeId","data-v-47b4bb56"]]),$=`## My Story\r
\r
...
\r
Given other users’ experiences, I am currently strongly convinced that eye muscle exercises can be a working tool for improving functional vision sharpness.`,Y=`## Disclaimer and Safety Precautions\r
\r
...
\r
Proceed carefully, avoid pain, respect recovery time, and treat this as serious physical training for the visual system rather than a quick medical cure.`,N=`## Application\r
\r
...
\r
[Open Stereo Reader and try it](/stereo-reader/app#try)`,O=`## My Goals\r
\r
### 🚩 Personal goal\r
\r
...
\r
People who want to study the Bates method can still do so. It may have therapeutic value for some users. But in my opinion, its limitations should be recognized: relaxation alone is often not enough. In more difficult cases, real training may be required.`,J=`## How to Join the Project\r
\r
...
* [Subscribe to the YouTube channel](https://www.youtube.com/@IMPROVE-VISION-STEREO-READER) for future tutorials, explanations, and learning videos.`,U={class:"features"},W={class:"story"},L=u({__name:"index",setup(f){return P({ogTitle:"Alek Labs - Home for productivity tools",ogDescription:"Personal website of senior frontend developer Alexander Nenashev",ogImage:new URL("./assets/logo.jpg",import.meta.url).pathname}),(o,e)=>{const t=B;return p(),g(q,null,[a(H,{style:{"margin-bottom":"32px"}}),r("div",U,[a(d,{title:"Read your favorite books","image-url":n(_)},{default:m(()=>[...e[0]||(e[0]=[h(" You can read text, PDF, EPUB, FB2 files in stereo or mono mode ",-1)])]),_:1},8,["image-url"]),a(d,{title:"Relax your eyes","image-url":n(S)},{default:m(()=>[...e[1]||(e[1]=[h(" You can read books or view images with comfortable settings to relax your eyes with parallel view ",-1)])]),_:1},8,["image-url"]),a(d,{title:"Train your eyes","image-url":n(R)},{default:m(()=>[...e[2]||(e[2]=[h(" You can train your vision to improve focus and clarity by reading with more challenging settings (smaller font size, wider gap between columns, longer distance) ",-1)])]),_:1},8,["image-url"])]),r("div",W,[a(t,{class:"chapter",src:n($)},null,8,["src"]),a(t,{class:"chapter",src:n(D)},null,8,["src"]),a(t,{class:"chapter",src:n(N)},null,8,["src"]),a(t,{class:"chapter",src:n(O)},null,8,["src"]),a(t,{class:"chapter",src:n(C)},null,8,["src"]),a(t,{class:"chapter",src:n(Y)},null,8,["src"]),a(t,{class:"chapter",src:n(J)},null,8,["src"])])],64)}}}),ae=y(L,[["__scopeId","data-v-232e441f"]]);export{ae as default};
