import{_ as h}from"./C9O7TYzd.js";import{a as m,U as p,a4 as i,P as a,g as d,d as e,k as s,l as c,a3 as l,S as f,M as b,C as g,r as k}from"./DakN_buV.js";import{_ as y,f as w}from"./CNk8DTmI.js";import{M as v}from"./Do4ktST4.js";const x=`Modern JavaScript applications often process large amounts of data before anything is rendered: filtering, mapping, grouping, sorting, formatting, diffing, normalizing API responses, preparing view models, and running framework-level update logic. In small isolated cases the difference between two implementations may look irrelevant, but in real applications these operations are usually repeated many times. Small overheads accumulate, especially on low-end devices, older hardware, and mobile browsers.
...
<script src="https://cdn.jsdelivr.net/gh/silentmantra/benchmark/loader.js"><\/script>
<!-- <script type="module" src="http://localhost:8001/benchmark.js"><\/script> -->`,A={class:"wrapper","show-benchmark-code":""},j={src:k,class:"cover"},$={class:"subtitle subtitle-2"},_=["innerHTML"],S={__name:"index",setup(T){p({title:"JS benchmark",link:[{rel:"icon",type:"image/svg+xml",href:w}]});const u=new v({html:!0}).render(x);return(t,n)=>{const o=h,r=b("transition-target");return i((g(),d("div",A,[n[3]||(n[3]=e("h1",null,[e("img",{src:y}),s(" AlekLabs JS benchmark")],-1)),n[4]||(n[4]=e("div",{class:"subtitle"},"A benchmark to write in pure JS and host anywhere",-1)),i(e("img",j,null,512),[[r,[(t._.provides[a]||t.$route).fullPath,"cover"]]]),e("div",$,[c(o,{to:"/js-benchmark/playground"},{default:l(()=>[...n[0]||(n[0]=[s("Open playground",-1)])]),_:1}),c(o,{to:"/js-benchmark/playground#H4sIAAAAAAAACm3PQQrCMBQE0KsMWUiiIVbBTUXRA3gC6yK20Rab3%2FKbClJ6dylZqOBumMVjZhB5UziRiryhLsAyY4cjs32ZGzdeDrWjeyhTrJJk1JAKuz3kQL1PcbKhNGypaLxUo1LbjDJaLnG4OspLb%2FmBW1UHx1jA2zYjy2xiI2lyyFDvsYfZKONt%2B13Osf7nsSv63EUpZilZg%2BKsj4fZDGzavivlx9NgpXG%2BqK3QIlShnn5HBc%2FuZ6sY35i0sGoZAQAA"},{default:l(()=>[...n[1]||(n[1]=[s("Try in playground: reduce vs filter + map",-1)])]),_:1}),n[2]||(n[2]=e("a",{href:"https://stackoverflow.com/search?tab=newest&q=user%3a14098260%20benchmark&searchOn=3",target:"_blank"},"My Stack Overflow answers with benchmarks",-1))]),e("div",{class:"content jsbench-content",innerHTML:f(u)},null,8,_)])),[[r,[(t._.provides[a]||t.$route).fullPath,"article"]]])}}},B=m(S,[["__scopeId","data-v-2c85f11b"]]);export{B as default};
