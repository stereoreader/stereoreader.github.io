import{_ as h}from"./DkBTplrG.js";import{a4 as i,P as a,g as m,d as e,k as s,l as c,a3 as l,R as p,M as d,C as f}from"./BdF9BpuX.js";import{_ as b,f as g}from"./CxR2JFHe.js";import{j as k}from"./BlwWLGxN.js";import{M as y}from"./Do4ktST4.js";import{u as w}from"./Bl4DhjDQ.js";import{_ as v}from"./DlAUqK2U.js";const x=`Modern JavaScript applications often process large amounts of data before anything is rendered: filtering, mapping, grouping, sorting, formatting, diffing, normalizing API responses, preparing view models, and running framework-level update logic. In small isolated cases the difference between two implementations may look irrelevant, but in real applications these operations are usually repeated many times. Small overheads accumulate, especially on low-end devices, older hardware, and mobile browsers.
...
<script src="https://cdn.jsdelivr.net/gh/silentmantra/benchmark/loader.js"><\/script>
<!-- <script type="module" src="http://localhost:8001/benchmark.js"><\/script> -->`,A={class:"wrapper","show-benchmark-code":""},j={src:k,class:"cover"},_={class:"subtitle subtitle-2"},$=["innerHTML"],S={__name:"index",setup(T){w({title:"JS benchmark",link:[{rel:"icon",type:"image/svg+xml",href:g}]});const u=new y({html:!0}).render(x);return(t,n)=>{const o=h,r=d("transition-target");return i((f(),m("div",A,[n[3]||(n[3]=e("h1",null,[e("img",{src:b}),s(" AlekLabs JS benchmark")],-1)),n[4]||(n[4]=e("div",{class:"subtitle"},"A benchmark to write in pure JS and host anywhere",-1)),i(e("img",j,null,512),[[r,[(t._.provides[a]||t.$route).fullPath,"cover"]]]),e("div",_,[c(o,{to:"/js-benchmark/playground"},{default:l(()=>[...n[0]||(n[0]=[s("Open playground",-1)])]),_:1}),c(o,{to:"/js-benchmark/playground#H4sIAAAAAAAACm3PQQrCMBQE0KsMWUiiIVbBTUXRA3gC6yK20Rab3%2FKbClJ6dylZqOBumMVjZhB5UziRiryhLsAyY4cjs32ZGzdeDrWjeyhTrJJk1JAKuz3kQL1PcbKhNGypaLxUo1LbjDJaLnG4OspLb%2FmBW1UHx1jA2zYjy2xiI2lyyFDvsYfZKONt%2B13Osf7nsSv63EUpZilZg%2BKsj4fZDGzavivlx9NgpXG%2BqK3QIlShnn5HBc%2FuZ6sY35i0sGoZAQAA"},{default:l(()=>[...n[1]||(n[1]=[s("Try in playground: reduce vs filter + map",-1)])]),_:1}),n[2]||(n[2]=e("a",{href:"https://stackoverflow.com/search?tab=newest&q=user%3a14098260%20benchmark&searchOn=3",target:"_blank"},"My Stack Overflow answers with benchmarks",-1))]),e("div",{class:"content jsbench-content",innerHTML:p(u)},null,8,$)])),[[r,[(t._.provides[a]||t.$route).fullPath,"article"]]])}}},J=v(S,[["__scopeId","data-v-2c85f11b"]]);export{J as default};
