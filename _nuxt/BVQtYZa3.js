import{_ as a}from"./DNu4-DAD.js";import{_ as c,f as l}from"./BSZUkOvr.js";import{j as u}from"./BJV7fBDF.js";import{M as h}from"./Do4ktST4.js";import{u as m}from"./CvriNMlk.js";import{_ as p}from"./DlAUqK2U.js";import{g as d,d as e,k as t,l as o,a1 as r,P as f,C as b}from"./Cz8q5L1R.js";const g=`Modern JavaScript applications often process large amounts of data before anything is rendered: filtering, mapping, grouping, sorting, formatting, diffing, normalizing API responses, preparing view models, and running framework-level update logic. In small isolated cases the difference between two implementations may look irrelevant, but in real applications these operations are usually repeated many times. Small overheads accumulate, especially on low-end devices, older hardware, and mobile browsers.
...
<script src="https://cdn.jsdelivr.net/gh/silentmantra/benchmark/loader.js"><\/script>
<!-- <script type="module" src="http://localhost:8001/benchmark.js"><\/script> -->`,k={class:"wrapper","show-benchmark-code":""},y={class:"subtitle subtitle-2"},x=["innerHTML"],w={__name:"index",setup(v){m({title:"JS benchmark",link:[{rel:"icon",type:"image/svg+xml",href:l}]});const i=new h({html:!0}).render(g);return(A,n)=>{const s=a;return b(),d("div",k,[n[3]||(n[3]=e("h1",null,[e("img",{src:c}),t(" AlekLabs JS benchmark")],-1)),n[4]||(n[4]=e("div",{class:"subtitle"},"A benchmark to write in pure JS and host anywhere",-1)),n[5]||(n[5]=e("img",{src:u,class:"cover"},null,-1)),e("div",y,[o(s,{to:"/js-benchmark/playground"},{default:r(()=>[...n[0]||(n[0]=[t("Open playground",-1)])]),_:1}),o(s,{to:"/js-benchmark/playground#H4sIAAAAAAAACm3PQQrCMBQE0KsMWUiiIVbBTUXRA3gC6yK20Rab3%2FKbClJ6dylZqOBumMVjZhB5UziRiryhLsAyY4cjs32ZGzdeDrWjeyhTrJJk1JAKuz3kQL1PcbKhNGypaLxUo1LbjDJaLnG4OspLb%2FmBW1UHx1jA2zYjy2xiI2lyyFDvsYfZKONt%2B13Osf7nsSv63EUpZilZg%2BKsj4fZDGzavivlx9NgpXG%2BqK3QIlShnn5HBc%2FuZ6sY35i0sGoZAQAA"},{default:r(()=>[...n[1]||(n[1]=[t("Try in playground: reduce vs filter + map",-1)])]),_:1}),n[2]||(n[2]=e("a",{href:"https://stackoverflow.com/search?tab=newest&q=user%3a14098260%20benchmark&searchOn=3",target:"_blank"},"My Stack Overflow answers with benchmarks",-1))]),e("div",{class:"content jsbench-content",innerHTML:f(i)},null,8,x)])}}},I=p(w,[["__scopeId","data-v-0b7a1952"]]);export{I as default};
