import{t as E,_ as v,h as W}from"./index-DKTcuKG0.js";import{I as j,C as Y,s as R}from"./App-D6sxUB1d.js";class M{isEnabled(){return!1}debug(){}info(){}warn(){}error(){}perf(){}}class V{isEnabled(){return!0}debug(n,e,...r){console.debug(`${n}.${e}`,...r)}info(n,e,...r){console.info(`${n}.${e}`,...r)}warn(n,e,...r){console.warn(`${n}.${e}`,...r)}error(n,e,...r){console.error(`${n}.${e}`,...r)}perf(n,e,r,o,...a){console.info(`${n}.${e}.${r}.${o}`,...a)}}class q{constructor(n,e){this.logger=n,this.level=e}isEnabled(n){const e={debug:0,info:1,warn:2,error:3};return this.level<=e[n]}debug(n,e,...r){this.level<=0&&this.logger.debug(n,e,...r)}info(n,e,...r){this.level<=1&&this.logger.info(n,e,...r)}warn(n,e,...r){this.level<=2&&this.logger.warn(n,e,...r)}error(n,e,...r){this.level<=3&&this.logger.error(n,e,...r)}perf(n,e,r,o,...a){this.logger.perf(n,e,r,o,...a)}}class X{constructor(){this.marks=new Map}isEnabled(){return!1}debug(n,e,...r){}info(n,e,...r){}warn(n,e,...r){}error(n,e,...r){}perf(n,e,r,o,a,...i){const s=`${n}.${e}.${r}.${o}.${a}`;switch(o){case"Begin":globalThis.performance.mark(s,{detail:i}),this.marks.set(`${n}.${e}.${r}.${a}`,Date.now());break;case"End":globalThis.performance.mark(s,{detail:i});const l=`${n}.${e}.${r}.Measure.${a}`,u=`${n}.${e}.${r}.Begin.${a}`;globalThis.performance.measure(l,u,s);const S=this.marks.get(`${n}.${e}.${r}.${a}`);if(S){const z=Date.now()-S;console.info(`⏱️ ${n}.${e}.${r}.${a}: ${z}ms`),this.marks.delete(`${n}.${e}.${r}.${a}`)}break}}}class K{constructor(n){this.loggers=n}isEnabled(n){return this.loggers.some(e=>e.isEnabled(n))}debug(n,e,...r){for(const o of this.loggers)o.debug(n,e,...r)}info(n,e,...r){for(const o of this.loggers)o.info(n,e,...r)}warn(n,e,...r){for(const o of this.loggers)o.warn(n,e,...r)}error(n,e,...r){for(const o of this.loggers)o.error(n,e,...r)}perf(n,e,r,o,...a){for(const i of this.loggers)i.perf(n,e,r,o,...a)}}var x=(t=>(t[t.Pending=0]="Pending",t[t.Resolved=1]="Resolved",t[t.Rejected=2]="Rejected",t[t.Aborted=3]="Aborted",t))(x||{});class Q extends Error{constructor(n){super(`Task aborted: ${JSON.stringify(n)}`),this.name="TaskAbortedError",this.reason=n}}class Z extends Error{constructor(n){super(`Task rejected: ${JSON.stringify(n)}`),this.name="TaskRejectedError",this.reason=n}}class m{constructor(){this.state={stage:0},this.resolvedCallbacks=[],this.rejectedCallbacks=[],this._promise=null,this.progressCbs=[]}toPromise(){return this._promise||(this._promise=new Promise((n,e)=>{this.wait(r=>n(r),r=>{r.type==="abort"?e(new Q(r.reason)):e(new Z(r.reason))})})),this._promise}wait(n,e){switch(this.state.stage){case 0:this.resolvedCallbacks.push(n),this.rejectedCallbacks.push(e);break;case 1:n(this.state.result);break;case 2:e({type:"reject",reason:this.state.reason});break;case 3:e({type:"abort",reason:this.state.reason});break}}resolve(n){if(this.state.stage===0){this.state={stage:1,result:n};for(const e of this.resolvedCallbacks)try{e(n)}catch{}this.resolvedCallbacks=[],this.rejectedCallbacks=[]}}reject(n){if(this.state.stage===0){this.state={stage:2,reason:n};for(const e of this.rejectedCallbacks)try{e({type:"reject",reason:n})}catch{}this.resolvedCallbacks=[],this.rejectedCallbacks=[]}}abort(n){if(this.state.stage===0){this.state={stage:3,reason:n};for(const e of this.rejectedCallbacks)try{e({type:"abort",reason:n})}catch{}this.resolvedCallbacks=[],this.rejectedCallbacks=[]}}fail(n){n.type==="abort"?this.abort(n.reason):this.reject(n.reason)}onProgress(n){this.progressCbs.push(n)}progress(n){for(const e of this.progressCbs)e(n)}static all(n){const e=new m;if(n.length===0)return e.resolve([]),e;const r=new Array(n.length);let o=0,a=!1;return n.forEach((i,s)=>{i.wait(l=>{a||(r[s]=l,o++,o===n.length&&(a=!0,e.resolve(r)))},l=>{a||(a=!0,l.type==="abort"?e.abort(l.reason):e.reject(l.reason))})}),e}static allSettled(n){const e=new m;if(n.length===0)return e.resolve([]),e;const r=new Array(n.length);let o=0;return n.forEach((a,i)=>{a.wait(s=>{r[i]={status:"resolved",value:s},o++,o===n.length&&e.resolve(r)},s=>{r[i]={status:s.type==="abort"?"aborted":"rejected",reason:s.reason},o++,o===n.length&&e.resolve(r)})}),e}static race(n){const e=new m;if(n.length===0)return e.reject("No tasks provided"),e;let r=!1;return n.forEach(o=>{o.wait(a=>{r||(r=!0,e.resolve(a))},a=>{r||(r=!0,a.type==="abort"?e.abort(a.reason):e.reject(a.reason))})}),e}static withProgress(n,e){const r=m.all(n);if(e){let o=0;n.forEach(a=>{a.wait(()=>{o++,e(o,n.length)},()=>{o++,e(o,n.length)})})}return r}}const J="­",nn="​",en="⁠",tn="\uFEFF",rn="￾",on="￿",an=Object.freeze([J,nn,en,tn,rn,on]);new RegExp(`[${an.join("")}]`,"g");var p=(t=>(t[t.Unknown=-1]="Unknown",t[t.Courier=0]="Courier",t[t.Courier_Bold=1]="Courier_Bold",t[t.Courier_BoldOblique=2]="Courier_BoldOblique",t[t.Courier_Oblique=3]="Courier_Oblique",t[t.Helvetica=4]="Helvetica",t[t.Helvetica_Bold=5]="Helvetica_Bold",t[t.Helvetica_BoldOblique=6]="Helvetica_BoldOblique",t[t.Helvetica_Oblique=7]="Helvetica_Oblique",t[t.Times_Roman=8]="Times_Roman",t[t.Times_Bold=9]="Times_Bold",t[t.Times_BoldItalic=10]="Times_BoldItalic",t[t.Times_Italic=11]="Times_Italic",t[t.Symbol=12]="Symbol",t[t.ZapfDingbats=13]="ZapfDingbats",t))(p||{}),O=(t=>(t[t.Left=0]="Left",t[t.Center=1]="Center",t[t.Right=2]="Right",t))(O||{}),c=(t=>(t[t.Normal=0]="Normal",t[t.Multiply=1]="Multiply",t[t.Screen=2]="Screen",t[t.Overlay=3]="Overlay",t[t.Darken=4]="Darken",t[t.Lighten=5]="Lighten",t[t.ColorDodge=6]="ColorDodge",t[t.ColorBurn=7]="ColorBurn",t[t.HardLight=8]="HardLight",t[t.SoftLight=9]="SoftLight",t[t.Difference=10]="Difference",t[t.Exclusion=11]="Exclusion",t[t.Hue=12]="Hue",t[t.Saturation=13]="Saturation",t[t.Color=14]="Color",t[t.Luminosity=15]="Luminosity",t))(c||{});const sn=Object.freeze({1:"invisible",2:"hidden",4:"print",8:"noZoom",16:"noRotate",32:"noView",64:"readOnly",128:"locked",256:"toggleNoView"});Object.entries(sn).reduce((t,[n,e])=>(t[e]=Number(n),t),{});var f=(t=>(t[t.ANSI=0]="ANSI",t[t.DEFAULT=1]="DEFAULT",t[t.SYMBOL=2]="SYMBOL",t[t.SHIFTJIS=128]="SHIFTJIS",t[t.HANGEUL=129]="HANGEUL",t[t.GB2312=134]="GB2312",t[t.CHINESEBIG5=136]="CHINESEBIG5",t[t.GREEK=161]="GREEK",t[t.VIETNAMESE=163]="VIETNAMESE",t[t.HEBREW=177]="HEBREW",t[t.ARABIC=178]="ARABIC",t[t.CYRILLIC=204]="CYRILLIC",t[t.THAI=222]="THAI",t[t.EASTERNEUROPEAN=238]="EASTERNEUROPEAN",t))(f||{}),C=(t=>(t[t.Create=0]="Create",t[t.Read=1]="Read",t[t.Update=2]="Update",t[t.Delete=3]="Delete",t))(C||{}),A=(t=>(t[t.Ok=0]="Ok",t[t.Unknown=1]="Unknown",t[t.NotFound=2]="NotFound",t[t.WrongFormat=3]="WrongFormat",t[t.Password=4]="Password",t[t.Security=5]="Security",t[t.PageError=6]="PageError",t[t.XFALoad=7]="XFALoad",t[t.XFALayout=8]="XFALayout",t[t.Cancelled=9]="Cancelled",t[t.Initialization=10]="Initialization",t[t.NotReady=11]="NotReady",t[t.NotSupport=12]="NotSupport",t[t.LoadDoc=13]="LoadDoc",t[t.DocNotOpen=14]="DocNotOpen",t[t.CantCloseDoc=15]="CantCloseDoc",t[t.CantCreateNewDoc=16]="CantCreateNewDoc",t[t.CantImportPages=17]="CantImportPages",t[t.CantCreateAnnot=18]="CantCreateAnnot",t[t.CantSetAnnotRect=19]="CantSetAnnotRect",t[t.CantSetAnnotContent=20]="CantSetAnnotContent",t[t.CantRemoveInkList=21]="CantRemoveInkList",t[t.CantAddInkStoke=22]="CantAddInkStoke",t[t.CantReadAttachmentSize=23]="CantReadAttachmentSize",t[t.CantReadAttachmentContent=24]="CantReadAttachmentContent",t[t.CantFocusAnnot=25]="CantFocusAnnot",t[t.CantSelectText=26]="CantSelectText",t[t.CantSelectOption=27]="CantSelectOption",t[t.CantCheckField=28]="CantCheckField",t[t.CantSetAnnotString=29]="CantSetAnnotString",t))(A||{});const B=Object.freeze([{id:O.Left,label:"Left",css:"left"},{id:O.Center,label:"Center",css:"center"},{id:O.Right,label:"Right",css:"right"}]);B.reduce((t,n)=>(t[n.id]=n,t),{});B.reduce((t,n)=>(t[n.css]=n.id,t),{});B.map(t=>({value:t.id,label:t.label}));var $=(t=>(t.Courier="Courier",t.Helvetica="Helvetica",t.Times="Times",t.Symbol="Symbol",t.ZapfDingbats="ZapfDingbats",t.Unknown="Unknown",t))($||{});p.Helvetica;const dn={id:p.Helvetica,family:"Helvetica",bold:!1,italic:!1,label:"Helvetica",css:"Helvetica, Arial, sans-serif"},N=Object.freeze([{id:p.Courier,family:"Courier",bold:!1,italic:!1,label:"Courier",css:"Courier, monospace"},{id:p.Courier_Bold,family:"Courier",bold:!0,italic:!1,label:"Courier Bold",css:'"Courier-Bold", Courier, monospace'},{id:p.Courier_BoldOblique,family:"Courier",bold:!0,italic:!0,label:"Courier Bold Oblique",css:'"Courier-BoldOblique", Courier, monospace'},{id:p.Courier_Oblique,family:"Courier",bold:!1,italic:!0,label:"Courier Oblique",css:'"Courier-Oblique", Courier, monospace'},dn,{id:p.Helvetica_Bold,family:"Helvetica",bold:!0,italic:!1,label:"Helvetica Bold",css:'"Helvetica-Bold", Arial, sans-serif'},{id:p.Helvetica_BoldOblique,family:"Helvetica",bold:!0,italic:!0,label:"Helvetica Bold Oblique",css:'"Helvetica-BoldOblique", Arial, sans-serif'},{id:p.Helvetica_Oblique,family:"Helvetica",bold:!1,italic:!0,label:"Helvetica Oblique",css:'"Helvetica-Oblique", Arial, sans-serif'},{id:p.Times_Roman,family:"Times",bold:!1,italic:!1,label:"Times Roman",css:'"Times New Roman", Times, serif'},{id:p.Times_Bold,family:"Times",bold:!0,italic:!1,label:"Times Bold",css:'"Times New Roman Bold", Times, serif'},{id:p.Times_BoldItalic,family:"Times",bold:!0,italic:!0,label:"Times Bold Italic",css:'"Times New Roman Bold Italic", Times, serif'},{id:p.Times_Italic,family:"Times",bold:!1,italic:!0,label:"Times Italic",css:'"Times New Roman Italic", Times, serif'},{id:p.Symbol,family:"Symbol",bold:!1,italic:!1,label:"Symbol",css:"Symbol"},{id:p.ZapfDingbats,family:"ZapfDingbats",bold:!1,italic:!1,label:"Zapf Dingbats",css:"ZapfDingbats"}]);N.reduce((t,n)=>(t[n.id]=n,t),{});const ln=new Map;for(const t of N)ln.set(`${t.family}_${t.bold}_${t.italic}`,t.id);Object.values($).filter(t=>t!=="Unknown").map(t=>({value:t,label:t}));[...new Set(N.map(t=>t.family))];const G=Object.freeze([{id:c.Normal,label:"Normal",css:"normal"},{id:c.Multiply,label:"Multiply",css:"multiply"},{id:c.Screen,label:"Screen",css:"screen"},{id:c.Overlay,label:"Overlay",css:"overlay"},{id:c.Darken,label:"Darken",css:"darken"},{id:c.Lighten,label:"Lighten",css:"lighten"},{id:c.ColorDodge,label:"Color Dodge",css:"color-dodge"},{id:c.ColorBurn,label:"Color Burn",css:"color-burn"},{id:c.HardLight,label:"Hard Light",css:"hard-light"},{id:c.SoftLight,label:"Soft Light",css:"soft-light"},{id:c.Difference,label:"Difference",css:"difference"},{id:c.Exclusion,label:"Exclusion",css:"exclusion"},{id:c.Hue,label:"Hue",css:"hue"},{id:c.Saturation,label:"Saturation",css:"saturation"},{id:c.Color,label:"Color",css:"color"},{id:c.Luminosity,label:"Luminosity",css:"luminosity"}]);G.reduce((t,n)=>(t[n.id]=n,t),{});G.reduce((t,n)=>(t[n.css]=n.id,t),{});G.map(t=>({value:t.id,label:t.label}));G.map(t=>t.id);function L(t){if(t instanceof M)return{type:"noop"};if(t instanceof V)return{type:"console"};if(t instanceof X)return{type:"perf"};if(t instanceof q){const n=t;return{type:"level",config:{level:n.level,logger:L(n.logger)}}}return t instanceof K?{type:"all",config:{loggers:t.loggers.map(L)}}:{type:"noop"}}class y extends m{constructor(n={}){super(),this.children=new Map,this.childResults=[],this.completedCount=0,this.expectedCount=0,this.isFinalized=!1,this.config={aggregate:n.aggregate??(e=>e),onChildComplete:n.onChildComplete??(()=>{}),failFast:n.failFast??!0}}addChild(n,e){if(this.state.stage!==x.Pending)return this.state.stage===x.Aborted&&n.abort(this.state.reason),this;const r=e??this.expectedCount;return this.expectedCount=Math.max(this.expectedCount,r+1),this.children.set(n,r),n.wait(o=>this.handleChildSuccess(n,o,r),o=>this.handleChildError(n,o,r)),this}finalize(){return this.isFinalized?this:(this.isFinalized=!0,this.expectedCount===0&&this.resolve(this.config.aggregate([])),this)}handleChildSuccess(n,e,r){if(this.state.stage!==x.Pending)return;this.childResults[r]=e,this.completedCount++,this.children.delete(n);const o=this.config.onChildComplete(this.completedCount,this.expectedCount,e,r);if(o!==void 0&&this.progress(o),this.completedCount===this.expectedCount){const a=this.config.aggregate(this.childResults);this.resolve(a)}}handleChildError(n,e,r){if(this.state.stage===x.Pending){if(this.children.delete(n),this.config.failFast){for(const[o]of this.children)o.abort("Sibling task failed");this.children.clear(),this.fail(e)}else if(this.childResults[r]=void 0,this.completedCount++,this.completedCount===this.expectedCount){const o=this.config.aggregate(this.childResults);this.resolve(o)}}}abort(n){for(const[e]of this.children)e.abort(n);this.children.clear(),super.abort(n)}reject(n){for(const[e]of this.children)e.abort(n);this.children.clear(),super.reject(n)}getPendingCount(){return this.children.size}getCompletedCount(){return this.completedCount}static gather(n){const e=new y({aggregate:r=>r,onChildComplete:(r,o)=>({completed:r,total:o})});return n.forEach((r,o)=>e.addChild(r,o)),e.finalize(),e}static gatherIndexed(n){const e=new y({aggregate:r=>{const o={};return r.forEach((a,i)=>{o[i]=a}),o},onChildComplete:(r,o,a,i)=>({page:i,result:a})});return n.forEach((r,o)=>e.addChild(r,o)),e.finalize(),e}static gatherFrom(n,e){const r=new y(e);return n.forEach((o,a)=>r.addChild(o,a)),r.finalize(),r}static first(n){let e=!1;const r=new y({aggregate:o=>o[0],failFast:!1});return r.handleChildSuccess=(o,a)=>{if(!e){e=!0;for(const[i]of r.children)i!==o&&i.abort("Race won by sibling");r.resolve(a)}},n.forEach((o,a)=>r.addChild(o,a)),r.finalize(),r}}const b="TaskQueue",D="Queue";var d=(t=>(t[t.CRITICAL=3]="CRITICAL",t[t.HIGH=2]="HIGH",t[t.MEDIUM=1]="MEDIUM",t[t.LOW=0]="LOW",t))(d||{});class un{constructor(n={}){this.queue=[],this.running=0,this.resultTasks=new Map,this.idleListeners=new Set;const{concurrency:e=1,comparator:r,ranker:o,onIdle:a,maxQueueSize:i,autoStart:s=!0,logger:l}=n;this.logger=l??new M,this.opts={concurrency:Math.max(1,e),comparator:r,ranker:o,onIdle:a??(()=>{}),maxQueueSize:i??Number.POSITIVE_INFINITY,autoStart:s}}setComparator(n){this.opts.comparator=n}setRanker(n){this.opts.ranker=n}size(){return this.queue.length}inFlight(){return this.running}isIdle(){return this.queue.length===0&&this.running===0}async drain(){this.isIdle()||await new Promise(n=>{const e=()=>{this.isIdle()&&(this.offIdle(e),n())};this.onIdle(e)})}notifyIdle(){this.isIdle()&&([...this.idleListeners].forEach(n=>n()),this.idleListeners.clear(),this.opts.onIdle())}onIdle(n){this.idleListeners.add(n)}offIdle(n){this.idleListeners.delete(n)}enqueue(n,e={}){const r=this.generateId(),o=e.priority??1,a=new m;if(this.queue.length>=this.opts.maxQueueSize){const l=new Error("Queue is full (maxQueueSize reached).");return a.reject(l),a}this.resultTasks.set(r,a);const i={id:r,priority:o,meta:e.meta??n.meta,executeFactory:n.execute};this.queue.push(i),this.logger.debug(b,D,`Task enqueued: ${r} | Priority: ${o} | Running: ${this.running} | Queued: ${this.queue.length}`);const s=a.abort.bind(a);return a.abort=l=>{this.logger.debug(b,D,`Task aborted: ${r}`),this.cancel(r),s(l)},this.opts.autoStart&&this.process(e.fifo===!0),a}cancel(n){const e=this.queue.length;this.queue=this.queue.filter(r=>r.id===n?(r.cancelled=!0,!1):!0),this.resultTasks.delete(n),e!==this.queue.length&&(this.logger.debug(b,D,`Task cancelled and removed: ${n}`),this.kick())}kick(){queueMicrotask(()=>this.process())}async process(n=!1){for(this.logger.debug(b,D,`process() called | Running: ${this.running} | Concurrency: ${this.opts.concurrency} | Queued: ${this.queue.length}`);this.running<this.opts.concurrency&&this.queue.length>0;){this.logger.debug(b,D,`Starting new task | Running: ${this.running} | Queued: ${this.queue.length}`),n||this.sortQueue();const e=this.queue.shift();if(e.cancelled){this.logger.debug(b,D,`Skipping cancelled task: ${e.id}`);continue}const r=this.resultTasks.get(e.id);r&&(this.running++,(async()=>{let o=null;try{if(o=e.executeFactory(),!o)throw new Error("Task factory returned null/undefined");o.wait(a=>{r.state.stage===0&&r.resolve(a)},a=>{r.state.stage===0&&(a.type==="abort"?r.abort(a.reason):r.reject(a.reason))}),o.onProgress(a=>{r.progress(a)}),await o.toPromise()}catch(a){r.state.stage===0&&r.reject(a)}finally{this.resultTasks.delete(e.id),this.running--,this.logger.debug(b,D,`Task completed: ${e.id} | Running: ${this.running} | Queued: ${this.queue.length}`),this.isIdle()?this.notifyIdle():this.queue.length>0&&this.kick()}})().catch(o=>{this.logger.error(b,D,"Unhandled error in task execution wrapper:",o),this.running=Math.max(0,this.running-1),this.isIdle()?this.notifyIdle():this.queue.length>0&&this.kick()}))}}sortQueue(){const{comparator:n,ranker:e}=this.opts;if(n){this.queue.sort(n);return}const r=new Map,o=a=>e?(r.has(a.id)||r.set(a.id,e(a)),r.get(a.id)):this.defaultRank(a);this.queue.sort((a,i)=>{if(a.priority!==i.priority)return i.priority-a.priority;const s=o(a),l=o(i);return s!==l?l-s:this.extractTime(a.id)-this.extractTime(i.id)})}defaultRank(n){return 0}generateId(){return typeof crypto<"u"&&"randomUUID"in crypto?crypto.randomUUID():`${Date.now()}-${Math.random().toString(36).slice(2)}`}extractTime(n){const e=Number(n.split("-")[0]);return Number.isFinite(e)?e:0}}const k="PdfEngine",w="Orchestrator";class cn{constructor(n,e){this.executor=n,this.logger=e.logger??new M,this.options={imageConverter:e.imageConverter,fetcher:e.fetcher??(typeof fetch<"u"?(r,o)=>fetch(r,o):void 0),logger:this.logger},this.workerQueue=new un({concurrency:1,autoStart:!0,logger:this.logger}),this.logger.debug(k,w,"PdfEngine orchestrator created")}chunkArray(n,e){const r=[];for(let o=0;o<n.length;o+=e)r.push(n.slice(o,o+e));return r}isSupport(n){const e=new m;return e.resolve([C.Create,C.Read,C.Update,C.Delete]),e}destroy(){var n,e;const r=new m;try{this.executor.destroy(),(e=(n=this.options.imageConverter).destroy)==null||e.call(n),r.resolve(!0)}catch(o){r.reject({code:A.Unknown,message:String(o)})}return r}openDocumentUrl(n,e){const r=new m;return(async()=>{try{if(!this.options.fetcher)throw new Error("Fetcher is not set");const a=await(await this.options.fetcher(n.url,e?.requestOptions)).arrayBuffer(),i={id:n.id,content:a};this.openDocumentBuffer(i,{password:e?.password,normalizeRotation:e?.normalizeRotation}).wait(s=>r.resolve(s),s=>r.fail(s))}catch(o){r.reject({code:A.Unknown,message:String(o)})}})(),r}openDocumentBuffer(n,e){return this.workerQueue.enqueue({execute:()=>this.executor.openDocumentBuffer(n,e),meta:{docId:n.id,operation:"openDocumentBuffer"}},{priority:d.CRITICAL})}getMetadata(n){return this.workerQueue.enqueue({execute:()=>this.executor.getMetadata(n),meta:{docId:n.id,operation:"getMetadata"}},{priority:d.MEDIUM})}setMetadata(n,e){return this.workerQueue.enqueue({execute:()=>this.executor.setMetadata(n,e),meta:{docId:n.id,operation:"setMetadata"}},{priority:d.MEDIUM})}getDocPermissions(n){return this.workerQueue.enqueue({execute:()=>this.executor.getDocPermissions(n),meta:{docId:n.id,operation:"getDocPermissions"}},{priority:d.MEDIUM})}getDocUserPermissions(n){return this.workerQueue.enqueue({execute:()=>this.executor.getDocUserPermissions(n),meta:{docId:n.id,operation:"getDocUserPermissions"}},{priority:d.MEDIUM})}getSignatures(n){return this.workerQueue.enqueue({execute:()=>this.executor.getSignatures(n),meta:{docId:n.id,operation:"getSignatures"}},{priority:d.MEDIUM})}getBookmarks(n){return this.workerQueue.enqueue({execute:()=>this.executor.getBookmarks(n),meta:{docId:n.id,operation:"getBookmarks"}},{priority:d.MEDIUM})}setBookmarks(n,e){return this.workerQueue.enqueue({execute:()=>this.executor.setBookmarks(n,e),meta:{docId:n.id,operation:"setBookmarks"}},{priority:d.MEDIUM})}deleteBookmarks(n){return this.workerQueue.enqueue({execute:()=>this.executor.deleteBookmarks(n),meta:{docId:n.id,operation:"deleteBookmarks"}},{priority:d.MEDIUM})}renderPage(n,e,r){return this.renderWithEncoding(()=>this.executor.renderPageRaw(n,e,r),r,n.id,e.index,d.CRITICAL)}renderPageRect(n,e,r,o){return this.renderWithEncoding(()=>this.executor.renderPageRect(n,e,r,o),o,n.id,e.index,d.HIGH)}renderThumbnail(n,e,r){return this.renderWithEncoding(()=>this.executor.renderThumbnailRaw(n,e,r),r,n.id,e.index,d.MEDIUM)}renderPageAnnotation(n,e,r,o){return this.renderWithEncoding(()=>this.executor.renderPageAnnotationRaw(n,e,r,o),o,n.id,e.index,d.MEDIUM)}renderWithEncoding(n,e,r,o,a=d.CRITICAL){const i=new m,s=this.workerQueue.enqueue({execute:()=>n(),meta:{docId:r,pageIndex:o,operation:"render"}},{priority:a}),l=i.abort.bind(i);return i.abort=u=>{s.abort(u),l(u)},s.wait(u=>{i.state.stage===0&&this.encodeImage(u,e,i)},u=>{i.state.stage===0&&i.fail(u)}),i}encodeImage(n,e,r){const o=e?.imageType??"image/webp",a=e?.quality,i={data:new Uint8ClampedArray(n.data),width:n.width,height:n.height};this.options.imageConverter(()=>i,o,a).then(s=>r.resolve(s)).catch(s=>r.reject({code:A.Unknown,message:String(s)}))}getPageAnnotations(n,e){return this.workerQueue.enqueue({execute:()=>this.executor.getPageAnnotations(n,e),meta:{docId:n.id,pageIndex:e.index,operation:"getPageAnnotations"}},{priority:d.MEDIUM})}createPageAnnotation(n,e,r,o){return this.workerQueue.enqueue({execute:()=>this.executor.createPageAnnotation(n,e,r,o),meta:{docId:n.id,pageIndex:e.index,operation:"createPageAnnotation"}},{priority:d.MEDIUM})}updatePageAnnotation(n,e,r){return this.workerQueue.enqueue({execute:()=>this.executor.updatePageAnnotation(n,e,r),meta:{docId:n.id,pageIndex:e.index,operation:"updatePageAnnotation"}},{priority:d.MEDIUM})}removePageAnnotation(n,e,r){return this.workerQueue.enqueue({execute:()=>this.executor.removePageAnnotation(n,e,r),meta:{docId:n.id,pageIndex:e.index,operation:"removePageAnnotation"}},{priority:d.MEDIUM})}getAllAnnotations(n){const e=this.chunkArray(n.pages,500);this.logger.debug(k,w,`getAllAnnotations: ${n.pages.length} pages in ${e.length} chunks`);const r=new y({aggregate:o=>Object.assign({},...o)});return e.forEach((o,a)=>{const i=this.workerQueue.enqueue({execute:()=>this.executor.getAnnotationsBatch(n,o),meta:{docId:n.id,operation:"getAnnotationsBatch",chunkSize:o.length}},{priority:d.LOW});i.onProgress(s=>{r.progress({page:s.pageIndex,result:s.result})}),r.addChild(i,a)}),r.finalize(),r}getPageTextRects(n,e){return this.workerQueue.enqueue({execute:()=>this.executor.getPageTextRects(n,e),meta:{docId:n.id,pageIndex:e.index,operation:"getPageTextRects"}},{priority:d.MEDIUM})}searchAllPages(n,e,r){const o=Array.isArray(r?.flags)?r.flags.reduce((s,l)=>s|l,0):r?.flags??0,a=this.chunkArray(n.pages,25);this.logger.debug(k,w,`searchAllPages: ${n.pages.length} pages in ${a.length} chunks`);const i=new y({aggregate:s=>{const l=s.flatMap(u=>Object.values(u).flat());return{results:l,total:l.length}}});return a.forEach((s,l)=>{const u=this.workerQueue.enqueue({execute:()=>this.executor.searchBatch(n,s,e,o),meta:{docId:n.id,operation:"searchBatch",chunkSize:s.length}},{priority:d.LOW});u.onProgress(S=>{i.progress({page:S.pageIndex,results:S.result})}),i.addChild(u,l)}),i.finalize(),i}getAttachments(n){return this.workerQueue.enqueue({execute:()=>this.executor.getAttachments(n),meta:{docId:n.id,operation:"getAttachments"}},{priority:d.MEDIUM})}addAttachment(n,e){return this.workerQueue.enqueue({execute:()=>this.executor.addAttachment(n,e),meta:{docId:n.id,operation:"addAttachment"}},{priority:d.MEDIUM})}removeAttachment(n,e){return this.workerQueue.enqueue({execute:()=>this.executor.removeAttachment(n,e),meta:{docId:n.id,operation:"removeAttachment"}},{priority:d.MEDIUM})}readAttachmentContent(n,e){return this.workerQueue.enqueue({execute:()=>this.executor.readAttachmentContent(n,e),meta:{docId:n.id,operation:"readAttachmentContent"}},{priority:d.MEDIUM})}setFormFieldValue(n,e,r,o){return this.workerQueue.enqueue({execute:()=>this.executor.setFormFieldValue(n,e,r,o),meta:{docId:n.id,pageIndex:e.index,operation:"setFormFieldValue"}},{priority:d.MEDIUM})}flattenPage(n,e,r){return this.workerQueue.enqueue({execute:()=>this.executor.flattenPage(n,e,r),meta:{docId:n.id,pageIndex:e.index,operation:"flattenPage"}},{priority:d.MEDIUM})}extractPages(n,e){return this.workerQueue.enqueue({execute:()=>this.executor.extractPages(n,e),meta:{docId:n.id,pageIndexes:e,operation:"extractPages"}},{priority:d.MEDIUM})}extractText(n,e){return this.workerQueue.enqueue({execute:()=>this.executor.extractText(n,e),meta:{docId:n.id,pageIndexes:e,operation:"extractText"}},{priority:d.MEDIUM})}redactTextInRects(n,e,r,o){return this.workerQueue.enqueue({execute:()=>this.executor.redactTextInRects(n,e,r,o),meta:{docId:n.id,pageIndex:e.index,operation:"redactTextInRects"}},{priority:d.MEDIUM})}applyRedaction(n,e,r){return this.workerQueue.enqueue({execute:()=>this.executor.applyRedaction(n,e,r),meta:{docId:n.id,pageIndex:e.index,operation:"applyRedaction"}},{priority:d.MEDIUM})}applyAllRedactions(n,e){return this.workerQueue.enqueue({execute:()=>this.executor.applyAllRedactions(n,e),meta:{docId:n.id,pageIndex:e.index,operation:"applyAllRedactions"}},{priority:d.MEDIUM})}flattenAnnotation(n,e,r){return this.workerQueue.enqueue({execute:()=>this.executor.flattenAnnotation(n,e,r),meta:{docId:n.id,pageIndex:e.index,operation:"flattenAnnotation"}},{priority:d.MEDIUM})}getTextSlices(n,e){return this.workerQueue.enqueue({execute:()=>this.executor.getTextSlices(n,e),meta:{docId:n.id,slices:e,operation:"getTextSlices"}},{priority:d.MEDIUM})}getPageGlyphs(n,e){return this.workerQueue.enqueue({execute:()=>this.executor.getPageGlyphs(n,e),meta:{docId:n.id,pageIndex:e.index,operation:"getPageGlyphs"}},{priority:d.MEDIUM})}getPageGeometry(n,e){return this.workerQueue.enqueue({execute:()=>this.executor.getPageGeometry(n,e),meta:{docId:n.id,pageIndex:e.index,operation:"getPageGeometry"}},{priority:d.MEDIUM})}merge(n){return this.workerQueue.enqueue({execute:()=>this.executor.merge(n),meta:{docId:n.map(e=>e.id).join(","),operation:"merge"}},{priority:d.MEDIUM})}mergePages(n){return this.workerQueue.enqueue({execute:()=>this.executor.mergePages(n),meta:{docId:n.map(e=>e.docId).join(","),operation:"mergePages"}},{priority:d.MEDIUM})}preparePrintDocument(n,e){return this.workerQueue.enqueue({execute:()=>this.executor.preparePrintDocument(n,e),meta:{docId:n.id,operation:"preparePrintDocument"}},{priority:d.MEDIUM})}saveAsCopy(n){return this.workerQueue.enqueue({execute:()=>this.executor.saveAsCopy(n),meta:{docId:n.id,operation:"saveAsCopy"}},{priority:d.MEDIUM})}closeDocument(n){return this.workerQueue.enqueue({execute:()=>this.executor.closeDocument(n),meta:{docId:n.id,operation:"closeDocument"}},{priority:d.MEDIUM})}closeAllDocuments(){return this.workerQueue.enqueue({execute:()=>this.executor.closeAllDocuments(),meta:{operation:"closeAllDocuments"}},{priority:d.MEDIUM})}setDocumentEncryption(n,e,r,o){return this.workerQueue.enqueue({execute:()=>this.executor.setDocumentEncryption(n,e,r,o),meta:{docId:n.id,operation:"setDocumentEncryption"}},{priority:d.MEDIUM})}removeEncryption(n){return this.workerQueue.enqueue({execute:()=>this.executor.removeEncryption(n),meta:{docId:n.id,operation:"removeEncryption"}},{priority:d.MEDIUM})}unlockOwnerPermissions(n,e){return this.workerQueue.enqueue({execute:()=>this.executor.unlockOwnerPermissions(n,e),meta:{docId:n.id,operation:"unlockOwnerPermissions"}},{priority:d.MEDIUM})}isEncrypted(n){return this.workerQueue.enqueue({execute:()=>this.executor.isEncrypted(n),meta:{docId:n.id,operation:"isEncrypted"}},{priority:d.MEDIUM})}isOwnerUnlocked(n){return this.workerQueue.enqueue({execute:()=>this.executor.isOwnerUnlocked(n),meta:{docId:n.id,operation:"isOwnerUnlocked"}},{priority:d.MEDIUM})}}class U extends Error{constructor(n){super(n),this.name="ImageConverterError"}}const pn=(t,n="image/webp",e)=>{if(typeof document>"u")return Promise.reject(new U("document is not available. This converter requires a browser environment."));const r=t(),o=new ImageData(r.data,r.width,r.height);return new Promise((a,i)=>{const s=document.createElement("canvas");s.width=o.width,s.height=o.height,s.getContext("2d").putImageData(o,0,0),s.toBlob(l=>{l?a(l):i(new U("Canvas toBlob returned null"))},n,e)})};function mn(t){const n=async(e,r="image/webp",o)=>{try{const a=e(),i=new Uint8ClampedArray(a.data);return await t.encode({data:i,width:a.width,height:a.height},r,o)}catch(a){return console.warn("Worker encoding failed, falling back to main-thread Canvas:",a),pn(e,r,o)}};return n.destroy=()=>t.destroy(),n}const gn=[{file:"NotoSansJP-Thin.otf",weight:100},{file:"NotoSansJP-Light.otf",weight:300},{file:"NotoSansJP-DemiLight.otf",weight:350},{file:"NotoSansJP-Regular.otf",weight:400},{file:"NotoSansJP-Medium.otf",weight:500},{file:"NotoSansJP-Bold.otf",weight:700},{file:"NotoSansJP-Black.otf",weight:900}],Pn=[{file:"NotoSansKR-Thin.otf",weight:100},{file:"NotoSansKR-Light.otf",weight:300},{file:"NotoSansKR-DemiLight.otf",weight:350},{file:"NotoSansKR-Regular.otf",weight:400},{file:"NotoSansKR-Medium.otf",weight:500},{file:"NotoSansKR-Bold.otf",weight:700},{file:"NotoSansKR-Black.otf",weight:900}],fn=[{file:"NotoSansHans-Light.otf",weight:300},{file:"NotoSansHans-DemiLight.otf",weight:350},{file:"NotoSansHans-Regular.otf",weight:400},{file:"NotoSansHans-Medium.otf",weight:500},{file:"NotoSansHans-Bold.otf",weight:700}],Fn=[{file:"NotoSansHant-Thin.otf",weight:100},{file:"NotoSansHant-Light.otf",weight:300},{file:"NotoSansHant-DemiLight.otf",weight:350},{file:"NotoSansHant-Regular.otf",weight:400},{file:"NotoSansHant-Medium.otf",weight:500},{file:"NotoSansHant-Bold.otf",weight:700},{file:"NotoSansHant-Black.otf",weight:900}],hn=[{file:"NotoNaskhArabic-Regular.ttf",weight:400},{file:"NotoNaskhArabic-Bold.ttf",weight:700}],_n=[{file:"NotoSansHebrew-Regular.ttf",weight:400},{file:"NotoSansHebrew-Bold.ttf",weight:700}],I=[{file:"NotoSans-Thin.ttf",weight:100},{file:"NotoSans-ThinItalic.ttf",weight:100,italic:!0},{file:"NotoSans-ExtraLight.ttf",weight:200},{file:"NotoSans-ExtraLightItalic.ttf",weight:200,italic:!0},{file:"NotoSans-Light.ttf",weight:300},{file:"NotoSans-LightItalic.ttf",weight:300,italic:!0},{file:"NotoSans-Regular.ttf",weight:400},{file:"NotoSans-Italic.ttf",weight:400,italic:!0},{file:"NotoSans-Medium.ttf",weight:500},{file:"NotoSans-MediumItalic.ttf",weight:500,italic:!0},{file:"NotoSans-SemiBold.ttf",weight:600},{file:"NotoSans-SemiBoldItalic.ttf",weight:600,italic:!0},{file:"NotoSans-Bold.ttf",weight:700},{file:"NotoSans-BoldItalic.ttf",weight:700,italic:!0},{file:"NotoSans-ExtraBold.ttf",weight:800},{file:"NotoSans-ExtraBoldItalic.ttf",weight:800,italic:!0},{file:"NotoSans-Black.ttf",weight:900},{file:"NotoSans-BlackItalic.ttf",weight:900,italic:!0}],g="RemoteExecutor",P="Worker",H=class T{constructor(n,e){this.worker=n,this.pendingRequests=new Map,this.requestCounter=0,this.handleMessage=r=>{const o=r.data;if(o.type==="ready"){this.logger.debug(g,P,"Worker is ready"),this.readyTask.resolve(!0);return}const a=this.pendingRequests.get(o.id);if(!a){this.logger.warn(g,P,`Received response for unknown request: ${o.id}`);return}switch(o.type){case"result":this.logger.debug(g,P,`Received result for ${o.id}`),a.resolve(o.data),this.pendingRequests.delete(o.id);break;case"error":this.logger.debug(g,P,`Received error for ${o.id}:`,o.error),o.error?a.fail(o.error):a.reject({code:A.Unknown,message:"Unknown error"}),this.pendingRequests.delete(o.id);break;case"progress":this.logger.debug(g,P,`Received progress for ${o.id}`),a.progress(o.progress);break}},this.logger=e.logger??new M,this.worker.addEventListener("message",this.handleMessage),this.readyTask=new m,this.pendingRequests.set(T.READY_TASK_ID,this.readyTask),this.worker.postMessage({id:T.READY_TASK_ID,type:"wasmInit",wasmUrl:e.wasmUrl,logger:e.logger?L(e.logger):void 0,fontFallback:e.fontFallback}),this.logger.debug(g,P,"RemoteExecutor created")}generateId(){return`req-${Date.now()}-${this.requestCounter++}`}send(n,e){const r=this.generateId(),o=new m,a={id:r,type:"execute",method:n,args:e};return this.readyTask.wait(()=>{this.pendingRequests.set(r,o),this.logger.debug(g,P,`Sending ${n} request:`,r),this.worker.postMessage(a)},i=>{this.logger.error(g,P,`Worker init failed, rejecting ${n}:`,i),o.reject({code:A.Initialization,message:"Worker initialization failed"})}),o}destroy(){this.worker.removeEventListener("message",this.handleMessage),this.pendingRequests.forEach((n,e)=>{e!==T.READY_TASK_ID&&(n.abort("Worker destroyed"),this.logger.debug(g,P,`Aborted pending request: ${e}`))}),this.pendingRequests.clear(),this.worker.terminate(),this.logger.debug(g,P,"RemoteExecutor destroyed")}openDocumentBuffer(n,e){return this.send("openDocumentBuffer",[n,e])}getMetadata(n){return this.send("getMetadata",[n])}setMetadata(n,e){return this.send("setMetadata",[n,e])}getDocPermissions(n){return this.send("getDocPermissions",[n])}getDocUserPermissions(n){return this.send("getDocUserPermissions",[n])}getSignatures(n){return this.send("getSignatures",[n])}getBookmarks(n){return this.send("getBookmarks",[n])}setBookmarks(n,e){return this.send("setBookmarks",[n,e])}deleteBookmarks(n){return this.send("deleteBookmarks",[n])}renderPageRaw(n,e,r){return this.send("renderPageRaw",[n,e,r])}renderPageRect(n,e,r,o){return this.send("renderPageRect",[n,e,r,o])}renderThumbnailRaw(n,e,r){return this.send("renderThumbnailRaw",[n,e,r])}renderPageAnnotationRaw(n,e,r,o){return this.send("renderPageAnnotationRaw",[n,e,r,o])}getPageAnnotationsRaw(n,e){return this.send("getPageAnnotationsRaw",[n,e])}getPageAnnotations(n,e){return this.send("getPageAnnotations",[n,e])}createPageAnnotation(n,e,r,o){return this.send("createPageAnnotation",[n,e,r,o])}updatePageAnnotation(n,e,r){return this.send("updatePageAnnotation",[n,e,r])}removePageAnnotation(n,e,r){return this.send("removePageAnnotation",[n,e,r])}getPageTextRects(n,e){return this.send("getPageTextRects",[n,e])}searchInPage(n,e,r,o){return this.send("searchInPage",[n,e,r,o])}getAnnotationsBatch(n,e){return this.send("getAnnotationsBatch",[n,e])}searchBatch(n,e,r,o){return this.send("searchBatch",[n,e,r,o])}getAttachments(n){return this.send("getAttachments",[n])}addAttachment(n,e){return this.send("addAttachment",[n,e])}removeAttachment(n,e){return this.send("removeAttachment",[n,e])}readAttachmentContent(n,e){return this.send("readAttachmentContent",[n,e])}setFormFieldValue(n,e,r,o){return this.send("setFormFieldValue",[n,e,r,o])}flattenPage(n,e,r){return this.send("flattenPage",[n,e,r])}extractPages(n,e){return this.send("extractPages",[n,e])}extractText(n,e){return this.send("extractText",[n,e])}redactTextInRects(n,e,r,o){return this.send("redactTextInRects",[n,e,r,o])}applyRedaction(n,e,r){return this.send("applyRedaction",[n,e,r])}applyAllRedactions(n,e){return this.send("applyAllRedactions",[n,e])}flattenAnnotation(n,e,r){return this.send("flattenAnnotation",[n,e,r])}getTextSlices(n,e){return this.send("getTextSlices",[n,e])}getPageGlyphs(n,e){return this.send("getPageGlyphs",[n,e])}getPageGeometry(n,e){return this.send("getPageGeometry",[n,e])}merge(n){return this.send("merge",[n])}mergePages(n){return this.send("mergePages",[n])}preparePrintDocument(n,e){return this.send("preparePrintDocument",[n,e])}saveAsCopy(n){return this.send("saveAsCopy",[n])}closeDocument(n){return this.send("closeDocument",[n])}closeAllDocuments(){return this.send("closeAllDocuments",[])}setDocumentEncryption(n,e,r,o){return this.send("setDocumentEncryption",[n,e,r,o])}removeEncryption(n){return this.send("removeEncryption",[n])}unlockOwnerPermissions(n,e){return this.send("unlockOwnerPermissions",[n,e])}isEncrypted(n){return this.send("isEncrypted",[n])}isOwnerUnlocked(n){return this.send("isOwnerUnlocked",[n])}};H.READY_TASK_ID="0";let bn=H;const F="ImageEncoderPool",h="Encoder";class Dn{constructor(n=2,e,r){this.poolSize=n,this.workerUrl=e,this.workers=[],this.pendingTasks=new Map,this.nextWorkerId=0,this.requestCounter=0,this.logger=r??new M,this.initialize()}initialize(){this.logger.debug(F,h,`Creating worker pool with ${this.poolSize} workers`);for(let n=0;n<this.poolSize;n++)try{const e=new Worker(this.workerUrl,{type:"module"});e.onmessage=this.handleWorkerMessage.bind(this),e.onerror=this.handleWorkerError.bind(this),this.workers.push(e),this.logger.debug(F,h,`Worker ${n} created successfully`)}catch(e){this.logger.error(F,h,`Failed to create worker ${n}:`,e)}}handleWorkerMessage(n){const e=n.data,r=this.pendingTasks.get(e.id);if(!r){this.logger.warn(F,h,`Received response for unknown task: ${e.id}`);return}if(this.pendingTasks.delete(e.id),e.type==="result")r.resolve(e.data);else{const o=e.data;r.reject(new Error(o.message))}}handleWorkerError(n){this.logger.error(F,h,"Worker error:",n.message)}getNextWorker(){if(this.workers.length===0)return null;const n=this.workers[this.nextWorkerId];return this.nextWorkerId=(this.nextWorkerId+1)%this.workers.length,n}encode(n,e="image/webp",r){return new Promise((o,a)=>{const i=this.getNextWorker();if(!i){a(new Error("No workers available in the pool"));return}const s=`encode-${Date.now()}-${this.requestCounter++}`;this.pendingTasks.set(s,{resolve:o,reject:a});const l={id:s,type:"encode",data:{imageData:{data:n.data,width:n.width,height:n.height},imageType:e,quality:r}};this.logger.debug(F,h,`Sending encoding request ${s} (${n.width}x${n.height})`),i.postMessage(l,[n.data.buffer])})}destroy(){this.logger.debug(F,h,"Destroying worker pool"),this.pendingTasks.forEach((n,e)=>{n.reject(new Error("Worker pool destroyed")),this.logger.debug(F,h,`Rejected pending task: ${e}`)}),this.pendingTasks.clear(),this.workers.forEach((n,e)=>{n.terminate(),this.logger.debug(F,h,`Worker ${e} terminated`)}),this.workers=[]}get activeWorkers(){return this.workers.length}get pendingTasksCount(){return this.pendingTasks.size}}function En(t,n){const e=n instanceof Object&&"debug"in n?{logger:n}:n||{},{logger:r,encoderPoolSize:o,fontFallback:a}=e,i=new Worker(URL.createObjectURL(new Blob([`var Rotation = /* @__PURE__ */ ((Rotation2) => {
...
`],{type:"application/javascript"})),{type:"module"}),s=new bn(i,{wasmUrl:t,logger:r,fontFallback:a}),l=URL.createObjectURL(new Blob([`async function encodeImage(imageData, imageType, quality) {
...
`],{type:"application/javascript"})),u=new Dn(o??2,l,r);return new cn(s,{imageConverter:mn(u),logger:r})}const yn=Object.freeze(Object.defineProperty({__proto__:null,createPdfiumEngine:En},Symbol.toStringTag,{value:"Module"}));function An(t="latest"){return{jp:`https://cdn.jsdelivr.net/npm/@embedpdf/fonts-jp@${t}/fonts`,kr:`https://cdn.jsdelivr.net/npm/@embedpdf/fonts-kr@${t}/fonts`,sc:`https://cdn.jsdelivr.net/npm/@embedpdf/fonts-sc@${t}/fonts`,tc:`https://cdn.jsdelivr.net/npm/@embedpdf/fonts-tc@${t}/fonts`,arabic:`https://cdn.jsdelivr.net/npm/@embedpdf/fonts-arabic@${t}/fonts`,hebrew:`https://cdn.jsdelivr.net/npm/@embedpdf/fonts-hebrew@${t}/fonts`,latin:`https://cdn.jsdelivr.net/npm/@embedpdf/fonts-latin@${t}/fonts`}}function _(t,n){return t.map(e=>({url:`${n}/${e.file}`,weight:e.weight,italic:e.italic}))}function Sn(t){return{fonts:{[f.SHIFTJIS]:_(gn,t.jp),[f.HANGEUL]:_(Pn,t.kr),[f.GB2312]:_(fn,t.sc),[f.CHINESEBIG5]:_(Fn,t.tc),[f.ARABIC]:_(hn,t.arabic),[f.HEBREW]:_(_n,t.hebrew),[f.CYRILLIC]:_(I,t.latin),[f.GREEK]:_(I,t.latin),[f.VIETNAMESE]:_(I,t.latin)}}}const xn=An("latest");Sn(xn);class Cn extends Y{noLeadingSpaces=!0;constructor(n){super(n)}calcRow(n,e,r){const o=r/this.aspectRatio+R.chunkGapReal;return e.push({offset:n,height:o,lines:[{idx:0,chunkPos:0,chunk:this,text:"",indices:[0,0]}],lineHeight:o}),o}images={};renderTask;onMounted(n){}onUnmounted(n){E(this).renderTask?.abort({message:"Chunk unmounted"})}async renderPage(n){if(typeof this.images[n]=="object")return;this.images[n]={};const e=E(this);try{const r=window.devicePixelRatio||1,o=n/this.pageWidth*r;e.renderTask=await e.item.renderPage(e.idx,{scaleFactor:o,imageType:"image/png"});const a=await e.renderTask.toPromise();delete e.renderTask,this.images[n]={url:e.item.createObjectURL(a),width:e.pageWidth*o/r,height:e.pageHeight*o/r,dpr:r}}catch{delete this.images[n]}}component({lines:n,width:e},r){const o={overflow:"hidden",backgroundColor:"white",backgroundPosition:"center",backgroundRepeat:"no-repeat",height:r.height-R.chunkGapReal+"px"},a=this.images[e];a?"url"in a&&(a.dpr===1||(o.backgroundSize=`${a.width}px ${a.height}px`)):this.renderPage(e),R.pdfInvert&&(o.filter="invert(1)");const i=j.current.activeChunk.idx===this.idx;return[W("div",{idx:n?.[0],class:{active:i},style:o},a&&"url"in a?[W("img",{src:a.url,...a.dpr===1?{}:{width:a.width,height:a.height}})]:[])]}}class Tn extends j{get iconColor(){return"#FA0F00"}get icon(){return"pdf-file"}supports(n){return n!=="fontSize"}constructor(){super();const n=["engine","document","openPromise"];for(const e of n)Object.defineProperty(this,e,{writable:!0,configurable:!1,enumerable:!1,value:this[e]})}async onClose(){const n=E(this);n.openPromise=void 0,await n.engine.closeAllDocuments().toPromise(),await n.engine.destroy().toPromise();for(const e of n._chunks)e.images={};super.onClose()}async openDocument(){if(this.openPromise)return await this.openPromise;const{promise:n,reject:e,resolve:r}=Promise.withResolvers();this.openPromise=n;const o=(await v(async()=>{const{default:i}=await import("./pdfium-BAyoCJks.js");return{default:i}},[])).default,a=new URL(o,window.location.origin).toString();try{const i=E(this),{createPdfiumEngine:s}=await v(async()=>{const{createPdfiumEngine:l}=await Promise.resolve().then(()=>yn);return{createPdfiumEngine:l}},void 0);i.engine=s(a,{encoderPoolSize:4}),i.document=await i.engine.openDocumentBuffer({id:i.id,content:i.data}).toPromise(),r()}catch(i){e(i)}}async renderPage(n,e){const r=E(this);return await r.openDocument(),r.engine.renderPage(r.document,r.document.pages[n],e)}async parseInfo(){const n=E(this);await n.openDocument();{const o=await(await n.renderPage(0,{imageType:"image/png"})).toPromise(),{ImageUtils:a}=await v(async()=>{const{ImageUtils:i}=await import("./image-Bw4bEDZ9.js");return{ImageUtils:i}},[]);this.thumbnailUrl=await a.scaleToDataURL(o,null,3e4,300,"jpeg")}const e=await n.engine.getMetadata(n.document).toPromise();e.title&&!e.title.toLowerCase().includes("anonymous")&&(this.title=e.title),e.author&&!e.author.toLowerCase().includes("anonymous")&&(this.author=e.author)}async parseOutline(){const n=E(this),{bookmarks:e}=await n.engine.getBookmarks(n.document).toPromise();for(const o of e)r(o);function r(o,a=0){const i=o.title,{zoom:s,pageIndex:l}=o.target?.action?.destination??{};s&&n.addOutlineChunk({chunkIdx:l,text:i,level:a});for(const u of o.children??[])r(u,a+1)}}async parseData(){const n=E(this);await n.openDocument(),await n.parseOutline();for(let e=0;e<n.document.pageCount;e++){const r=await n.document.pages[e],{width:o,height:a}=r.size,i=o/a;n.addChunk({offset:e,pageIdx:e,pageWidth:o,pageHeight:a,aspectRatio:i,item:n},Cn)}return this}get chunks(){return this._chunks}}export{Tn as ItemPdf,Tn as default};
